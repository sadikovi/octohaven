...
(function() {
  var CurrentJob, JOB_CREATE, JOB_SUBMIT, breadcrumbs, breadcrumbsElem, currentJob, files, filesElem, jobCanvas, jobSettingElem, selectJar, selectedJarElem, setLoadStatus, setTextStatus, settings, statusBar, statuses, submitBtn, submitJob, _filelist, _mapper, _namer, _ref, _util,
  ...
  setTextStatus = function(text, ok) {
    var mode, obj;
    statusBar.innerHTML = "";
