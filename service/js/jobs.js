...
(function() {
  var ALL, CLOSED, CREATED, DELAYED, SUBMITTED, WAITING, actionLabel, all, blankslate, blankslateWithMsg, buttonColumn, closed, created, delayed, jobColumn, jobHistory, reloadJobs, resetLabels, row, selectLabel, statusColour, statusColumn, submitted, waiting, _jobloader, _loader, _mapper, _ref, _util;
  ...
  _ref = ["ALL", "CREATED", "SUBMITTED", "WAITING", "CLOSED", "DELAYED"], ALL = _ref[0], CREATED = _ref[1], SUBMITTED = _ref[2], WAITING = _ref[3], CLOSED = _ref[4], DELAYED = _ref[5];
