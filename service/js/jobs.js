...
(function() {
  var ALL, CLOSED, CREATED, DELAYED, FINISHED, WAITING, actionLabel, all, blankslate, blankslateWithMsg, buttonColumn, closed, created, delayed, finished, jobColumn, jobHistory, reloadJobs, resetLabels, row, selectLabel, statusColour, statusColumn, waiting, _jobloader, _loader, _mapper, _ref, _util;
  ...
  _ref = ["ALL", "CREATED", "FINISHED", "WAITING", "CLOSED", "DELAYED"], ALL = _ref[0], CREATED = _ref[1], FINISHED = _ref[2], WAITING = _ref[3], CLOSED = _ref[4], DELAYED = _ref[5];
