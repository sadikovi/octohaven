...
(function() {
  var ACTIVE, CANCELED, PAUSED, actionLabel, actionName, active, canceled, column, columnAction, columnName, columnStats, columnStatus, noncanceled, paused, resetLabels, row, selectLabel, statusColour, timetablesElem, update, _mapper, _misc, _ref, _timetableLoader, _util;
  ...
  _ref = ["ACTIVE", "PAUSED", "CANCELED"], ACTIVE = _ref[0], PAUSED = _ref[1], CANCELED = _ref[2];
  ...
  resetLabels = function() {
    ...
    return _util.removeClass(canceled, "selected");
  };
  ...
  _util.addEventListener(noncanceled, "click", function(e) {
    return actionLabel(e, noncanceled, [ACTIVE, PAUSED]);
  });
  ...
  _util.addEventListener(canceled, "click", function(e) {
    return actionLabel(e, canceled, [CANCELED]);
  });
