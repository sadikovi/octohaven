...
(function() {
  var blankslate, blankslateWithMsg, column, contentHeader, contentList, contentValue, jobDetailsElem, jobid, params, property, row, updateLogLinks, view, _jobloader, _mapper, _util,
    __slice = [].slice;
