...
class TimetableTestSuite(unittest.TestCase):
    ...
    def test_get(self):
        ...
        self.opts["job_uid"] = job.uid
        timetable = Timetable.create(**self.opts)
        res = Timetable.get(timetable.uid)
    ...
    def test_list(self):
        ...
        self.opts["job_uid"] = job.uid
        for x in range(5):
            Timetable.create(**self.opts)
        arr = Timetable.list(None)
    ...
    def test_json(self):
        ...
        self.opts["job_uid"] = job.uid
        timetable = Timetable.create(**self.opts)
        res = Timetable.get(timetable.uid).json()
    ...
    def test_stats(self):
        ...
        for x in range(10):
            job = Job.create(**self.jobOpts)
            latestStats = TimetableStats.create(timetable_uid=timetable.uid, job_uid=job.uid)
