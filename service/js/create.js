...
(function() {
  var CurrentJob, JOB_CREATE, JOB_SUBMIT, breadcrumbs, breadcrumbsElem, changeDelay, currentJob, delay, delay10min, delay1hr, delay30min, delay3hrs, delayNow, delays, files, filesElem, jobCanvas, jobSettingElem, selectJar, selectedJarElem, setLoadStatus, setSubmitStatus, setTextStatus, settings, statusBar, statuses, submitBtn, submitJob, _filelist, _i, _len, _mapper, _namer, _ref, _util,
  ...
  for (_i = 0, _len = delays.length; _i < _len; _i++) {
    delay = delays[_i];
    _util.addEventListener(delay, "click", function(e) {
      changeDelay(this);
      e.preventDefault();
      return e.stopPropagation();
    });
